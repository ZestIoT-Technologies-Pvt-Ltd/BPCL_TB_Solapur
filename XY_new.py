...
def update_list():
	...
	#Ignoring the crossed line 3 ones here
		...
		if int(current_dict[key]['yco']) > int(prev_dict[key]['yco']): #and int(current_dict[key]['xco']) < 335:
		...
		elif (int(prev_dict[key]['yco']) - int(current_dict[key]['yco']))<20:
